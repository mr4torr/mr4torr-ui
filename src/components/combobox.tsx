...
function ComboboxTrigger({ className, ...props }: ComboboxPrimitive.Trigger.Props) {
    return (
        <ComboboxPrimitive.Trigger
            className={cn("absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground", className)}
...
function ComboboxContent({
    ...
    return (
        <ComboboxPrimitive.Portal>
            <ComboboxPrimitive.Positioner align={align} className="isolate z-50" side={side} sideOffset={sideOffset}>
...
function ComboboxList({ className, children, ...props }: ComboboxPrimitive.List.Props) {
    return (
        <ComboboxPrimitive.List className={cn("flex flex-col gap-0.5", className)} data-slot="combobox-list" {...props}>
            {children}
