  ...
  "group/button inline-flex shrink-0 select-none items-center justify-center whitespace-nowrap rounded-lg border border-transparent bg-clip-padding font-medium outline-none transition-all focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        surface:
          "bg-alpha/5 text-alpha hover:bg-alpha/15 aria-expanded:bg-alpha/15 aria-expanded:text-background dark:bg-alpha/10",
        inverse: "bg-alpha text-background hover:bg-alpha/90 aria-expanded:bg-alpha/80 aria-expanded:text-background",
        destructive:
          "bg-destructive/10 text-destructive hover:bg-destructive/15 focus-visible:border-destructive/40 focus-visible:ring-destructive/20 dark:bg-destructive/20 dark:text-destructive/90 dark:focus-visible:ring-destructive/40 dark:hover:bg-destructive/30",
        link: "text-primary-foreground underline-offset-4 hover:underline dark:text-primary",
      },
      size: {
        default:
          "h-9 gap-1.5 in-data-[slot=button-group]:rounded-md px-2.5 text-sm has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
